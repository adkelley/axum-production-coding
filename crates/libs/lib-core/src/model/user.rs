...
pub struct UserForLogin {
    ...
    // -- pwd and token info
    pub pwd: Option<String>, // encrypted, #_scheme_id_#_hash
    pub pwd_salt: Uuid,      // used for hashing
    pub token_salt: Uuid,    // used for hashing
}
...
//       UserIden does not have to be exhausted, but just have to columns
